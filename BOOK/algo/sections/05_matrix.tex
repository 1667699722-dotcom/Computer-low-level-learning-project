...
\lstinputlisting[style=cstyle, firstline=14, lastline=40,
    caption=src/matrix/1.c — createMatrix / freeMatrix / printMatrix]
{../src/matrix/1.c}
...
\lstinputlisting[style=cstyle, firstline=42, lastline=66,
    caption=src/matrix/1.c — nextpoweroftwo + padMatrix]
{../src/matrix/1.c}
...
\lstinputlisting[style=cstyle, firstline=67, lastline=132,
    caption=src/matrix/1.c — combieMatrix / SplitMatrix / AddMatrix]
{../src/matrix/1.c}
...
\lstinputlisting[style=cstyle, firstline=134, lastline=190,
    caption=src/matrix/1.c — SquareMatrixMultiply（分治法矩阵乘法）]
{../src/matrix/1.c}
...
clang -o matrix src/matrix/1.c -lm
./matrix
\end{lstlisting}
