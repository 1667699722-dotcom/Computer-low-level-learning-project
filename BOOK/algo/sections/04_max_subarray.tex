...
\lstinputlisting[style=cstyle,
    caption=src/findmaximumsubarray/1.c — 暴力枚举法]
{../src/findmaximumsubarray/1.c}
...
\lstinputlisting[style=cstyle, firstline=1, lastline=35,
    caption=src/findmaximumsubarray/2.c — 跨中点的查找]
{../src/findmaximumsubarray/2.c}
...
\lstinputlisting[style=cstyle, firstline=36, lastline=61,
    caption=src/findmaximumsubarray/2.c — findmaximumsubarray 递归函数]
{../src/findmaximumsubarray/2.c}

\subsubsection{输入预处理和输出结果}

\lstinputlisting[style=cstyle, firstline=62, lastline=75,
    caption=src/findmaximumsubarray/2.c — main，把股价转成差分数组]
{../src/findmaximumsubarray/2.c}
