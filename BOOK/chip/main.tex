...
\input{chip/sections/01_concepts}

\section{adder.v：64 位字节加法器}
\input{chip/sections/02_adder}

\section{uart\_tx.v：UART 发送器}
\input{chip/sections/03_uart_tx}

\section{uart\_rx.v：UART 接收器}
\input{chip/sections/04_uart_rx}

\section{综合到 FPGA：从代码到硬件}
\input{chip/sections/05_fpga}

\section{与其他模块的关系}
\input{chip/sections/06_relation}
